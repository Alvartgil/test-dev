view: fct_metricas_agrupadas {
  ...
  measure: pickup_d {
    value_format: "0.0%"
    type: sum
    sql: DIV0(${i_habpen}-${i_habpen_pickup_d},${i_habpen_pickup_d});;
  }

  measure: pickup_w {
    value_format: "0.0%"
    type: sum
    sql: DIV0(${i_habpen}-${i_habpen_pickup_w},${i_habpen_pickup_w});;
  }

  measure: pickup_1_w {
    value_format: "0.0%"
    type: sum
    sql: DIV0(${i_habpen_pickup_w}-${i_habpen_pickup_1_w},${i_habpen_pickup_1_w});;
  }

  measure: pickup_2_w {
    value_format: "0.0%"
    type: sum
    sql: DIV0(${i_habpen_pickup_1_w}-${i_habpen_pickup_2_w},${i_habpen_pickup_2_w});;
  }

  measure: pickup_3_w {
    value_format: "0.0%"
    type: sum
    sql: DIV0(${i_habpen_pickup_2_w}-${i_habpen_pickup_3_w},${i_habpen_pickup_3_w});;
  }

  measure: pickup_4_w {
    value_format: "0.0%"
    type: sum
    sql: DIV0(${i_habpen_pickup_3_w}-${i_habpen_pickup_4_w},${i_habpen_pickup_4_w});;
  }

  measure: rooms_occupancy {
    value_format: "0.0%"
    type: sum
    sql: DIV0(${num_habitaciones},${habitaciones_capacidad});;
  }

  measure: adr {
    value_format: "0.0\%"
    type: sum
    sql: DIV0(${adr_numerador},${adr_denominador});;
  }
